...
import 'package:word_game_multiple/wordle/result.dart';
import 'package:word_game_multiple/wordle/word_holder.dart';
    ...
    return MaterialApp(
      ...
      appBar: AppBar(
        leading: GestureDetector(
          ...
          onTap: () => {print(ModalRoute.of(context)?.settings.name),Navigator.pop(context,'wordle'), print(ModalRoute.of(context)?.settings.name),},
        ),
